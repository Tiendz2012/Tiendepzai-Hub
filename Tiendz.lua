...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Tiendepzai Hub ch�o ae<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>H�y s? d?ng Fluxus d? c� tr?i nghi?m t?t!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>làm cho vui<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>chào<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Tiendepzai Hub", HidePremium = false, IntroText = "Tiendepzai Hub??", SaveConfig = true, ConfigFolder = "NightHub"})
...
OrionLib:MakeNotification({
    Name = "Tiendepzai Hub",
    Content = "d?i hub load config r?i m?i s�i nha",
    Image = "rbxassetid://8192162908",
    Time = 10
})
...
W:AddLabel("PH�T TRI?N B?I")
W:AddLabel("Tiendepzai Hub SCRIPT")
W:AddLabel("DiscordTiendepzai Hub")
local Section = W:AddSection({
    Name = "Status"
})
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : �ell c�(s?p c�)")
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("Cho th?ng n�o dell hi?u th� d�y l� t? d?ng d�nh h�nh n?m")
    ...
    while wait(.1) do
        if LockLevel then
            if game.Players.localPlayer.Data.Level.Value >= LockLevelValue then
                game.Players.localPlayer:Kick("Lock Level : Done[��ng Level m�y n�i r?i!]")
            end
        end
    end
end)
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Tiendepzai Hub(Noitification)",
                ...
                OrionLib:MakeNotification({
                    Name = "Tiendepzai Hub(Noitification)",
                    Content = "[VN] : L�m on h?y nhi?m v? farrm level(n?u c�)",
                    Image = "rbxassetid://8192162908",
                    Time = 9
                })
            end
